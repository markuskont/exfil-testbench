...
Vagrant.configure(2) do |config|
    ...
    config.vm.define "router1" do |router1|
        ...
        router1.vm.network "private_network", ip: "192.168.56.191", auto_config: false
    ...
    config.vm.define "router2" do |router2|
        ...
        router2.vm.network "private_network", ip: "192.168.56.192", auto_config: false
    ...
    config.vm.define "host" do |host|
        ...
        host.vm.network "private_network", ip: "192.168.56.193", auto_config: false
        host.vm.provision "shell", inline: $host_persist
        host.vm.provision "shell", inline: $host_private
    ...
    config.vm.define "cnc" do |cnc|
        ...
        cnc.vm.network "private_network", ip: "192.168.56.194", auto_config: false
        cnc.vm.provision "shell", inline: $cnc_persist
        cnc.vm.provision "shell", inline: $host_public
    ...
    config.vm.define "tap" do |tap|
        ...
        tap.vm.network "private_network", ip: "192.168.56.195", auto_config: false
